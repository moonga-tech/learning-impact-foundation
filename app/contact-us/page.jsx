        ...
        <>
            ...
            <div className="flex flex-col items-center justify-center bg-gray-100 p-6">
                ...
                <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-md">
                    ...
                    <p className="text-gray-600 mb-4">Email: <a href="mailto:info@learningimpactfoundation.org" className="text-blue-600 hover:underline">info@learningimpactfoundation.org</a></p>
